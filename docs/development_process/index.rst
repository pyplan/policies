...
Tools that perform SAST are implemented in the development process.


DevOps 
------

Pyplan has automatized the system Build + automatic Tests + versioned + deploy (to QA servers). 
